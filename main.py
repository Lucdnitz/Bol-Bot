...
async def help(context):
    ...
    , inline=False)
    embed.add_field(name="Clicker (BETA)", value=".clicker - Mostrará todos os comandos relacionados ao clicker.\nO comando está limitado para evitar problemas com a API do discord."
    , inline=False)
