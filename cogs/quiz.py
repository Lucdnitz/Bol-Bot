                ...
                if OnOff!='o':
                    ...
                    if (teste == True) and (SequenceMatcher(a=(msg.content).lower(),b=str(artistas[musInt])[2:-3]).ratio() >= 0.85 or SequenceMatcher(a=(msg.content).lower(),b=str(musicas[musInt])[2:-3]).ratio() >= 0.85) and (msg.channel == ch) and voice.is_playing():
                        ...
                        for j in range(len(resp)):
                            if SequenceMatcher(a=(msg.content).lower(),b=resp[j]).ratio() >= 0.9:
                                testeBol=False
                        if testeBol:
                            if(len(pontos)!=0):
                            ...
                            if SequenceMatcher(a=(msg.content).lower(),b=str(artistas[musInt])[2:-3]).ratio() >= 0.9:
                                resp.append((str(artistas[musInt])[2:-3]).lower())
                            if SequenceMatcher(a=(msg.content).lower(),b=str(musicas[musInt])[2:-3]).ratio() >= 0.9:
